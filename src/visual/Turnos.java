...
public class Turnos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botMenuPrincipal.setText("VOVER");
        botMenuPrincipal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botMenuPrincipalActionPerformed(evt);
            }
        });
        getContentPane().add(botMenuPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 490, -1, -1));
        ...
        botCxFturnos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botCxFturnosActionPerformed(evt);
            }
        });
        ...
        botAsigCanceConsuEspec.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botAsigCanceConsuEspecActionPerformed(evt);
            }
        });
    ...
    private void botAsigCanceTurnosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botAsigCanceTurnosActionPerformed
       PacienteReservaTurnos asignacion = new PacienteReservaTurnos();
    ...
    private void botCxFturnosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botCxFturnosActionPerformed
       TurnosConsulta consulta = new TurnosConsulta();
       consulta.setVisible(true);
       this.setVisible(false);
    }//GEN-LAST:event_botCxFturnosActionPerformed

    private void botAsigCanceConsuEspecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botAsigCanceConsuEspecActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_botAsigCanceConsuEspecActionPerformed
