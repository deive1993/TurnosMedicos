 ...
 * @author Rocio
 */
public class EstadoTurnosPacientes extends javax.swing.JFrame {

   
    public EstadoTurnosPacientes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha", "Hora", "Especialidad", "Profesional", "Estado"
            }
        ) {
        ...
        btonBuscar.setText("ELIMINAR");
        getContentPane().add(btonBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 310, 90, 30));
        ...
        getContentPane().add(btonLimpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 400, 90, 30));
        ...
        getContentPane().add(VolverMenuPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 460, 156, 30));

        btonBuscar1.setText("BUSCAR");
        getContentPane().add(btonBuscar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 250, 80, 30));
        ...
        getContentPane().add(btonLimpiar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 350, 90, 30));
